...
<section class="section">
  <div class="wrap prose">
    ...
    <p>Some work is notifiable under Part P &mdash; a new consumer unit, a new circuit, a rewire, or anything inside a bathroom &mdash; and has to be registered with Building Control. I handle that for you: the building notice goes in to your council before I start, they inspect, and they issue the completion certificate. The fee for the inspection is the council's, and I tell you what it is when I quote so it is in the price from the start.</p>
